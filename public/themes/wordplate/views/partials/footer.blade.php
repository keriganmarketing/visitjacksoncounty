<footer class="sticky-footer bg-dark py-4">
    <div class="container">
        <div class="row d-flex flex-wrap">
            <div class="col-md-6 col-lg-2 order-md-">
                <footer-menu v-bind:nav-items="{{ website_menu(3) }}" ></footer-menu>
            </div>
            <div class="col-lg-8" >
            ...
            <div class="col-md-6 col-lg-2">
                ...
                <social-icons :size="35" :margin=".25" class="d-flex social-icons justify-content-center mb-4" ></social-icons>
            </div>
        </div>    
    </div>
    <hr>
